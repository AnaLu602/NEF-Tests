...
def test_nef_ue_location_acquisition(report_api_ip, report_api_port, report_name, mini_api_ip, mini_api_port, nef_ip, nef_port, nef_user, nef_pass, napp_endpoint):
